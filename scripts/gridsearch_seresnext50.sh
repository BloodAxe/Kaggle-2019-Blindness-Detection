...
python train_classifier_baseline.py -m cls_seresnext50_max -a light -f 0 -b 60 --fp16 -o Adam -lr 1e-4\
  -e 20 -v --use-aptos2019 --use-idrid --use-messidor --warmup 20 --loss ce --transfer cls_seresnext50_max_pretrain.pth
sleep 5
...
python train_classifier_baseline.py -m cls_seresnext50_max -a light -f 0 -b 60 --fp16 -o Adam -d 0.5 -lr 1e-4\
  -e 50 -v --use-aptos2019 --use-idrid --use-messidor --loss soft_ce --transfer cls_seresnext50_max_pretrain.pth
sleep 5

# Let's check different loss functions
# Loss function: hybrid_kappa
python train_classifier_baseline.py -m cls_seresnext50_max -a light -f 0 -b 60 --fp16 -o Adam -d 0.5 -lr 1e-4\
  -e 50 -v --use-aptos2019 --use-idrid --use-messidor --loss hybrid_kappa --transfer cls_seresnext50_max_pretrain.pth
sleep 5

# Let's check different loss functions
# Loss function: focal
python train_classifier_baseline.py -m cls_seresnext50_max -a light -f 0 -b 60 --fp16 -o Adam -d 0.5 -lr 1e-4\
  -e 50 -v --use-aptos2019 --use-idrid --use-messidor --loss focal --transfer cls_seresnext50_max_pretrain.pth
sleep 5
